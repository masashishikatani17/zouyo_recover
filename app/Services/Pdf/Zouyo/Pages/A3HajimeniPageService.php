 ...
 * 1: はじめに
 */
class A3HajimeniPageService implements ZouyoPdfPageInterface
{
    ...
    public function render(TCPDF $pdf, array $payload): void
    {
        ...
        $templatePath = resource_path('/views/pdf/A3_01_pr_hajimeni.pdf');
        

        if (!is_file($templatePath)) {
            throw new \RuntimeException('A3HajimeniPageService: template not found: ' . $templatePath);
        }
